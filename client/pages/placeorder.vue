  ...
  <div class="container-fluid">
    <div class="shipping-address">
                    ...
                    <div class="a-row a-spacing-base" v-for="product in getCart" :key="product._id">
                      <div class="row">
                        ...
                        <div class="col-sm-9 col-9">
                          ...
                          <div class="a-row a-size-small">{{product.owner.title}}</div>
                          <div class="a-row">
                            <!-- Product's price -->
                          ...
                          >Sold by:&nbsp;Amazon.in Services, Inc</div>
                          <div class="a-row">
                      ...
                      <fieldset>
                        ...
                        <div class="a-spacing-mini wednesday">
                          ...
                          <span class="a-radio-label">
                            ...
                            >Rs. 50&nbsp;-&nbsp;Standard International Shipping - No Tracking</span>
                          </span>
                        </div>
                        <br />
                        <div class="a-spacing-mini tuesday">
                          ...
                          <span class="a-radio-label">
                            ...
                            <br />
                            <span class="a-color-secondary">Rs. 100&nbsp;-&nbsp;Shipping</span>
                          </span>
                        </div>
                      </fieldset>
                    </div>
                ...
                <div class="a-row">
                  ...
                  <div class="order-summary" style="font-size: 12px;">
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">Rs. {{getCartTotalPrice}}</div>
                    </div>
                    <div class="row">
                      <!-- Shipping cost -->
                      <div class="col-sm-6">Shipping & handling:</div>
                      <div class="col-sm-6 text-right">Rs. {{shipmentPrice}}</div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6 text-right">Rs. {{getTotalCartPriceWithShipping}}</div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">Estimated tax to be collected:</div>
                      <div class="col-sm-6 text-right">Rs. 0.00</div>
                    </div>
                    <hr />
                    <div class="row">
                      <div class="col-sm-6">
                      ...
                      <div class="col-sm-6 text-right">
                        <!-- Total Price with Shipping -->
                        <div class="a-color-price a-size-medium a-text-bold">Rs. {{getTotalCartPriceWithShipping}}</div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="a-row a-spacing-small a-spacing-top-small">
        ...
        <div class="a-color-secondary a-size-mini">
          <p class="a-color-secondary a-size-mini">
            ...
            <br />
            <br />Go to the
            <a href="#">Amazon.in homepage</a> without completing your order.
          </p>
        </div>
      </div>
      <hr />
      <p class="a-size-small a-text-center a-color-secondary" data-testid>
        <a href="#">Conditions of Use</a> |
        <a href="#">Privacy Notice</a> © 1996-2020, Amazon.com, Inc.
      </p>
    </div>
  </div>
  <!--/SHIPPING ADDRESS-->
...
export default {
  ...
  computed : {
      ...mapGetters(["getCart", "getCartTotalPrice","getTotalCartPriceWithShipping"])
  },
