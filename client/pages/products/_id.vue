        ...
        <div class="container-fluid">
            <div class="dp--container">
                <div class="row">
                    ...
                    <div class="cil-lg-3 col-md-3 col-sm-4">
                        <div class="leftCol">
                            <!-- Image -->
                            <div class="imgBlock">
                                <div class="eBooksimg">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-8">
                        <div class="centerCol">
                            ...
                            <div class="bylineinfo">
                                by
                                <a href="#" class="authorName">{{product.owner.title}}
                                    ...
                                    <div class="a-spacing-top-small">
                                        <div class="a-section a-spacing-none">
                                            <div class="a-section a-spacing-none a-spacing-top-mini">
                                                This item shipts to
                                                <b>New Delhi</b>
                                                <b>Get it by Monday, Jun 01 - Monday, Jun. 01</b>
                                ...
                                <span class="a-declarative">
                                    <a href="#" class="a-link-normal">
                                        <div class="a-row a-spacing-mini">
                                            ...
                                            <span class="a-size-small">Deliver to New Delhi</span>
                                        </div>
                                    </a>
                                </span>
                                <br />
